...
/* Private variables ---------------------------------------------------------*/
@tiny extern volatile MySin_Typedef sin @0xB0;/* Stores the sin structure in ram */
@tiny extern volatile u8 counter @0xFF;	 /* The counter variable for counting the Update cycles in TIM1 */

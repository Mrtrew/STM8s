...
void @near (* const _vectab[])() =
{
  ...
  (void @near (*)())0x8200,
	NonHandledInterrupt, /* irq8 - External interrupt 5 (GPIOF) */
...
#ifdef STM8S903
  (void @near (*)())0x8200,
  NonHandledInterrupt, /* irq13 - TIM5 Update/Overflow/Break/Trigger interrupt  */

  (void @near (*)())0x8200,
  NonHandledInterrupt, /* irq14 - TIM5 Capture/Compare interrupt */
  ...
  NonHandledInterrupt, /* irq19 - I2C interrupt */
	...
	(void @near (*)())0x8200,
  NonHandledInterrupt, /* irq20 - UART3 Tx interrupt */

  (void @near (*)())0x8200,
  NonHandledInterrupt, /* irq21 - UART3 Rx interrupt */
#elif defined (STM8S105)
  (void @near (*)())0x8200,
  NonHandledInterrupt, /* irq20 - UART2 Tx interrupt */

  (void @near (*)())0x8200,
  NonHandledInterrupt, /* irq21 - UART2 Rx interrupt */
...
#if defined(STM8S208) || defined(STM8S207)
  (void @near (*)())0x8200,
  NonHandledInterrupt, /* irq22 - ADC2 end of conversion interrupt */
#else /* STM8S105, STM8S103, STM8S903 */
	(void @near (*)())0x8200,
  NonHandledInterrupt, /* irq22 - ADC1 end of conversion/Analog watchdog interrupts */
#endif /* STM8S208, STM8S207 */

#ifdef STM8S903
  (void @near (*)())0x8200,
  NonHandledInterrupt, /* irq23 - TIM6 Update/Overflow/Trigger interrupt */
#else
  (void @near (*)())0x8200,

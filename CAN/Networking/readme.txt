/** @page Networking  Networking with CAN to control Leds
 ...
 The CAN is configured as follow:
  ...
  - CAN\Networking\main.c                    Main file containing the "main" function
  - CAN\Networking\main.h                    Main file declaration
  - CAN\Networking\stm8s_conf.h              Library Configuration file
  - CAN\Networking\stm8s_it.c                Interrupt routines source 
  - CAN\Networking\stm8s_it.h                Interrupt routines declaration
  - CAN\Networking\stm8_interrupt_vector.c   Interrupt vectors table
 ...
 - This example runs only on STM8S208 device.
  ...
  - This example has been tested with STMicroelectronics STM8/128-EVAL evaluation
    board (STM8S208 device) and ST Visual Develop (STVD) toolchain (Cosmic compiler).
...
@par How to use it ?
  ...
  - Load project image: Debug->Start/Stop Debug Session in the N (total number of CAN units) STM8S208 products
